  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <ProtectedRoute element={<Admin />} hasPermission={hasCriarEtiqueta} />
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute element={<Admin />} hasPermission={hasBuscaAvancada} />
        }
      />
      ...
      <Route
        ...
        element={
          <ProtectedRoute element={<Admin />} hasPermission={hasAdministrativo} />
        }
      />
      ...
      />
      <Route
        path='/dashboard/patrimonio-temporario'
        element={<Admin />}
      />

...
export function VisaoGeralUser() {
  ...
  useEffect(() => {
    setUrlBackground(`${urlGeral}user/upload/${user?.id}/cover`);
    setUrlPerfil(`${urlGeral}user/upload/${user?.id}/icon`);
  }, [user]);
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleUpload("background", user?.id || "")}

...
<div className="flex" onClick={() => updateResearcher(item)}>
            {item.csv_cod != undefined && ( <div className={`w-2 min-w-2 rounded-l-md dark:border-neutral-800 border min-h-[250px]  border-neutral-200 border-r-0 ${qualisColor[item.csv_cod.trim() as keyof typeof qualisColor]} min-h-full relative `}></div>)}
          ...
          >
           ...
           <div className="text-xs font-medium mb-2 flex items-center gap-2">{item.bem_cod}-{item.bem_dgv}
           {daysDifference <= 5 && (
           ...
           <Barcode size={16}/>
              ...
              <div className="flex items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="font-semibold text-lg">{item.mat_nom}</div>

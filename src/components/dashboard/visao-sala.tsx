...
>
  ...
  <ToggleGroupItem value="SP">SP</ToggleGroupItem>
        ...
        <DialogHeader className="pt-8 px-6 flex flex-col items-center">
               ...
               {validData.length == 1 ? (
                ' Você possui 1 novo item ocioso, deseja divulgar no Vitrine Patrimônio?'
               ):(
                `  Você possui ${validData.length} novos itens ociosos, deseja divulgar no Vitrine Patrimônio?`
               )}
                 </DialogTitle>

...
export function Finalizados() {
    ...
    return (
      ...
      <Helmet>
        <title>Processo Finalizado | Sistema Patrimônio</title>
      ...
      <main className="flex flex-col ">
        <div className="flex p-8 items-center justify-between">
          <div className="flex gap-2">
            ...
            <h1 className="text-xl font-semibold tracking-tight">Processo Finalizado</h1>
          </div>
...
<h1 className="z-[2] text-center max-w-[900px] text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1] md:block mb-4">
  Todos os <strong className="bg-eng-blue rounded-md px-3 pb-2 text-white font-medium">processos finalizados</strong> estão aqui.
 Acompanhe todos os  descartados.
</h1>

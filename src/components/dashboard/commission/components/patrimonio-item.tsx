...
import { JUSTIFICATIVAS_REJEICAO } from "./block-items-tinder";
// 👉 você vai importar do outro componente / módulo compartilhado
    ...
    try {
      ...
      const res = await fetch(`${urlGeral}catalog/${entry.id}/workflow`, {
        ...
        body: JSON.stringify({
          ...
          detail: {
            justificativa: justTxt?.trim() || undefined,
          ...
          <Alert className="rounded-t-none rounded-l-none dark:bg-neutral-800/50 bg-neutral-100/50">
            <div className="flex gap-2 items-center h-full whitespace-nowrap flex-wrap">
              ...
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  handleClickAction("REJEITADOS_COMISSAO");
                }}
              >
              ...
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  handleClickAction("DESFAZIMENTO");
                }}
              >
        ...
        <DialogContent className="">
          <DialogHeader>
            <DialogTitle className="text-2xl mb-2 font-medium max-w-[520px]">
              Confirmar {wfTarget === "DESFAZIMENTO" ? "ACEITE" : "RECUSA"} do
              item
            </DialogTitle>
          ...
          <div className="grid gap-4 ">
            {/* Combos de modelos de justificativa para ACEITAR e RECUSAR */}
            {(wfTarget === "DESFAZIMENTO" ||
              wfTarget === "REJEITADOS_COMISSAO") && (
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(val) => {
                    setPresetId(val);
                    fillPreset(val); // atualiza textarea imediatamente
                  }}
                >

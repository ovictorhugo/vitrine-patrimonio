...
export function Comission() {
  ...
  const { hasAdministracaoDaComissao } = usePermissions();
  ...
  const tabs = [
    { id: "meus-items", label: "Meus itens para avaliação", icon: ListTodo },
    {
      ...
      label: "Pareceristas",
      icon: Users,
      condition: !hasAdministracaoDaComissao,
    },
    {
      id: "estatistica",
      label: "Estatísticas",
      ...
      <main className="flex flex-col gap-8  flex-1 ">
        ...
        <Tabs defaultValue={tabs[0].id} value={value} className="relative ">
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="relative grid grid-cols-1">
                    <Button
                      variant="outline"
                      size="sm"
                      className={`absolute left-0 z-2 h-8 w-8 p-0 top-1 ${
                ...
                <div className="hidden xl:flex xl:flex-nowrap gap-2">
                  <div className="md:flex md:flex-nowrap gap-2"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          {hasAdministracaoDaComissao && (
            <TabsContent value="adm-comission" className="m-0 p-0">
              <AdmComission />
            </TabsContent>
          )}

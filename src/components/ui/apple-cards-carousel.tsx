  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="rounded-lg bg-gray-100 dark:bg-neutral-900 h-[400px] w-[600px] md:h-[400px] md:w-[600px] overflow-hidden flex flex-col items-start justify-start relative z-10"
      >

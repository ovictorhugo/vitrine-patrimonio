    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-[#02A8A8]  group-[.toast]:text-neutral-50 dark:group-[.toast]:bg-[#02A8A8]  dark:group-[.toast]:text-neutral-900",
          cancelButton:
            "group-[.toast]:bg-[#02A8A8]  group-[.toast]:text-neutral-500 dark:group-[.toast]:bg-[#02A8A8]  dark:group-[.toast]:text-neutral-400",
        },
      }}
      {...props}
    />

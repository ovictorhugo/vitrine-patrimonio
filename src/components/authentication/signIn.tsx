    ...
    Faça login com sua conta Minha UFMG.
                    ...
                    <div className="flex gap-3 flex-col">
                        <div>
                               ...
                               <a href={`http://conectee.eng.ufmg.br/v1/api/auth/shibboleth/login`}><Button className=" w-full" variant={'outline'} ><div className="h-[12px]"><MUfmg /></div>Login com Minha UFMG

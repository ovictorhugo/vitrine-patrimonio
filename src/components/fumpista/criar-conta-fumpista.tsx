...
export function CriarContaFumpista() {
    const { isOpen, type, onOpen } = useModalHomepage();
    const isModalOpen = isOpen && type === 'criar-conta-fumpista'
    ...
    return(
        ...
        {isModalOpen && (
             <div className="h-screen w-full flex items-center mx-16 relative">
                ...
                <h2 className=" text-3xl font-bold mb-1 max-w-[450px]">Encontramos os seus dados, crie uma conta para continuar</h2>
